...
export default class PoteryPage extends React.Component{
    ...
    render(){
        const {width, height, potery_stages} = this.state
                    ...
                    <div key={stage_index} className='stage' style={{opacity: opacity,}} >
                        {
                            poteries.map((elm,potery_index)=> 
                                <Sentence key={potery_index} data={elm} z={z} onClick={this.handleClickPotery}/>
                            )
                        }
                    </div>
                    )
...
class Sentence extends React.Component{
    ...
    render(){
        ...
        return(
        <div ref='container' style = {{left: x,top: y,}} className={'sentence animate'+ id} 
        onClick={()=>{
            // console.log(data)
            onClick(data)
        }}>
